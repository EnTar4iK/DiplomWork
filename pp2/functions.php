...
{
    return [
        'pickup_daycom' => 'Самовывоз: DАЙКОМ, ул. Советская, 214-а',
...
{
    return [
        ['27+', 'лет опыта', 'DАЙКОМ работает в Шахтах с 1997 года и обслуживает частных и корпоративных клиентов.'],
        ['2', 'точки выдачи', 'Самовывоз из DАЙКОМ на Советской и магазина «Компьютерный мир».'],
